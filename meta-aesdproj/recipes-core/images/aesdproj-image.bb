...
IMAGE_INSTALL += "gstreamer1.0 gstreamer1.0-plugins-base gstreamer1.0-plugins-good gstreamer1.0-plugins-bad gstreamer1.0-plugins-ugly gstreamer1.0-libav gstreamer1.0-dev libjpeg-turbo-dev"
#IMAGE_INSTALL += "xserver-xorg xinit"
IMAGE_INSTALL += "libusb1 libusb1-dev"
IMAGE_INSTALL += "micarray"
IMAGE_INSTALL += "liberation-fonts font-alias"
